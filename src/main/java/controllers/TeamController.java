...
import static objects.Team.memberList;
...
public class TeamController {
    ...
    public static void createTeam() {
        ...
        team = new Team(name, teamID, currentDateTime, teamMember);
    ...
    public static void addTeamMember(TeamMember teamMember) {
        ...
        if (UserController.userExists(id)) {
            team.addTeamMember((TeamMember) UserController.getUser(id));
        }
        Controller.runTeamController();
    }
    public static void assignRole() {
        ...
        member= memberList.get(id);
        Team.assignRole(memberList.get(member));
